            ...
            return searchResult.map((entry) =>
                <Col className="my-1 align-items-center justify-content-center">
                    <Card className="mx-2 align-self-center" style={{ width: '15rem' }}>
                        <Card.Header>
                            <Card.Img variant="fluid" src="logo512.png" style={{height: '9rem'}} />
                        </Card.Header>
                        <Card.Body>
      ...
      <Row>
        ...
        <Col>
            <div className="jumbotron">
                ...
                <p class="fs-4 fw-light mb-3">Find the best groceries!</p>
                <br/>
                <Form className="needs-validation" onSubmit={handleSearch}>
                    <Container className="mb-1 w-75">
                        <FormControl type="text" id="search" name="search" placeholder="Search products..." required />
                    </Container>
                    <Button type="submit" variant="primary" className="w-25 mt-4">Find groceries</Button>
                </Form>
            </div>
            {
                searchResult &&
                <div className="jumbotron">
                    <h1 class="display-5">Search Result</h1>
                    {
                        ...
                        <p class="fs-4 fw-light mb-3">^Your search had no results.</p>
                    }
                    <br />
                    {
                        searchResult.length > 0 &&
