        ...
        <>
                    ...
                    <div className="jumbotron justify-content-start">
                        <h1 class="display-5">Shopping Cart</h1>
                        {
                            ...
                            <p class="fs-4 fw-light mb-3">
                                You currently have no items in your Cart, go to the Products page to start adding groceries.
                            </p>
                        }
                        <br />
                        {
                        ...
                        <Row className="mt-3">
                        {
                            ...
                            <>
                                ...
                                {
                                    (!user || !user.username) &&
                                    <a class="btn btn-primary px-5" href="/login">Sign in</a>
                                }
                                {
                                    user && user.username &&
                                ...
                                <Col />
                                <Col>
                                    <Button variant="danger" className="px-5" id="clearCart" onClick={handleShowConfirmModal}>Clear cart</Button>
                                </Col>
                            </>   
                        }
                        {
            ...
            <Modal show={showConfirmModal} onHide={handleCloseConfirmModal}>
                <Modal.Header closeButton>
                    <Modal.Title>{selectedItem ? 'Remove from cart?' : 'Empty cart?'}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {selectedItem ? 'Are you sure you want to remove the item from the cart?' : 'Are you sure you want to empty your cart?'}
                </Modal.Body>
                <Modal.Footer>
                    <Col>
                    {
